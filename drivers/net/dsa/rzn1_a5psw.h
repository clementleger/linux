...
#define A5PSW_BCAST_STORM_LIMIT		0x3C
#define A5PSW_BCAST_STORM_VALUE		GENMASK(31, 16)
#define A5PSW_BCAST_STORM_TIMEOUT	GENMASK(15, 0)

#define A5PSW_MCAST_STORM_LIMIT		0x40
...
#define A5PSW_DISC_PORT_OFFSET(port)	(0x10 * (port))
#define A5PSW_ODISC			0x310
#define A5PSW_IDISC_VLAN		0x314
#define A5PSW_IDISC_UNTAGGED		0x318
#define A5PSW_IDISC_BLOCKED		0x31C
#define A5PSW_STAT_WORKAROUND		0x3F0
